...
parser.add_argument("--edm_steps", type=int, default=16)
...
parser.add_argument("--s_cfg", type=float, default=5.5)
parser.add_argument("--s_stage2", type=float, default=0.96)
...
parser.add_argument("--encoder_tile_size", type=int, default=2048)
parser.add_argument("--decoder_tile_size", type=int, default=256)
